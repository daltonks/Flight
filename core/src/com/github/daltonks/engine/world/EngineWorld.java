...
public abstract class EngineWorld implements StateListener, EngineInputProcessor {
    ...
    private LinkedList<Runnable> runAfterPhysicsStep = new LinkedList<Runnable>();
    protected SortedList<Entity> staticEntities = new SortedList<Entity>(100);
    private SortedList<Entity> entities = new SortedList<Entity>(50);
    protected SortedList<Entity> skyboxEntities = new SortedList<Entity>(1);
    ...
    protected void updateSunAndDrawSkybox() {
        ...
        EngineShaderProgram.setLightPositionInView(
                sunShaderLocInView.xf(),
                sunShaderLocInView.yf(),
                sunShaderLocInView.zf()
        );
