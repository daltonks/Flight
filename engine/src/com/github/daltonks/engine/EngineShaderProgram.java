...
public class EngineShaderProgram {
    ...
    public static void init() {
        program = new ShaderProgram(
                Gdx.files.getFileHandle("data/vertexshader.txt", Files.FileType.Classpath),
                Gdx.files.getFileHandle("data/fragmentshader.txt", Files.FileType.Classpath)
        );
        ...
        Util.startTimer();
        Models.bufferModelsToGL();
        System.out.println("Model GL buffering: " + Util.endTimer());
        Util.startTimer();
